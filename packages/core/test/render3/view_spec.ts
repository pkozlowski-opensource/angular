...
import {getEmbeddedViewFactory, viewContainerInsertAfter, getViewContainer, viewContainerRemove, viewContainerGet, viewContainerIndexOf, viewContainerLength, viewContainerAppend} from '@angular/core/src/render3/view';
...
describe('ViewContainer manipulation commands', () => {
  ...
  describe('viewContainerAppend', () => {
    it('should append views as the last view in the container', () => {
      /*
        <div></div><ng-template><span></span></ng-template>
      */
      const fixture = new TemplateFixture(
