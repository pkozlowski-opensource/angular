import {addToViewTree, createLContainer, createLView, createTView, getOrCreateTNode, refreshDynamicEmbeddedViews} from '../../src/render3/instructions/shared';
...
refreshDynamicEmbeddedViews(rootLView);
