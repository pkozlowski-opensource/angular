 ...
 * @codeGenApi
 */
export function ɵɵstyleMap(styles: {[styleName: string]: any} | string | null): typeof ɵɵstyleMap {
 ...
 * @codeGenApi
 */
export function ɵɵclassMap(classes: {[className: string]: any} | string | null): typeof ɵɵclassMap {
...
/**
* Common code between `ɵɵclassMap` and `ɵɵstyleStyle`.
*
