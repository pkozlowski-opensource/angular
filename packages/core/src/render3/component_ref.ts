...
import {LifecycleHooksFeature, createRootComponent, createRootComponentHost, createRootContext} from './component';
import {getComponentDef} from './definition';
import {NodeInjector, diPublicInInjector, getOrCreateNodeInjectorForNode} from './di';
import {assignTViewNodeToLView, createComponentView, createLView, createTNode, createTView, elementCreate, initNodeFlags, locateHostElement, markTNodeAsComponentHost, refreshDescendantViews} from './instructions/shared';
...
export class ComponentFactory<T> extends viewEngine_ComponentFactory<T> {
  ...
  create(
    ...
    // TODO(pk): extract it to a separate function as this is used in both bootstrap and dynamic
    // component creation
